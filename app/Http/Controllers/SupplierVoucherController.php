...
class SupplierVoucherController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = Validator::make($request->all(), [
            ...
            'motivo' => ['nullable', 'string', 'max:350'],
    ...
    protected function recalculateVoucherTotals(int $voucherId): void
    {
        ...
        $saldoPendiente = $capitalTotal - $capitalPagado;
    ...
    protected function getVoucherProgressStatus(object $voucher): array
    {
        ...
        $mensualidadVoucher = max(1, (int)$voucher->meses) > 0 ? $capitalTotal / max(1, (int)$voucher->meses) : 0;
        $deberiaLlevar = round($mesesExigibles * $mensualidadVoucher, 2);
