...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['nombre' => 'Seguridad', 'clave' => 'security_root', 'ruta' => null, 'icono' => 'fa-solid fa-shield-halved', 'parent' => null, 'orden' => 2],
            ['nombre' => 'Catálogos', 'clave' => 'catalogos_root', 'ruta' => null, 'icono' => 'fa-solid fa-folder-open', 'parent' => null, 'orden' => 3],
            ...
            ['nombre' => 'Permisos', 'clave' => 'permissions_module', 'ruta' => 'permisos', 'icono' => 'fa-solid fa-key', 'parent' => 'security_root', 'orden' => 3],
            ['nombre' => 'Menú', 'clave' => 'menus_module', 'ruta' => 'catalogos/menus', 'icono' => 'fa-solid fa-list', 'parent' => 'security_root', 'orden' => 4],
            ['nombre' => 'Asignación lotificaciones', 'clave' => 'development_visibility_module', 'ruta' => 'asignacion-lotificaciones', 'icono' => 'fa-solid fa-map-location-dot', 'parent' => 'security_root', 'orden' => 5],
            ...
            ['nombre' => 'Tipos de cobro', 'clave' => 'charge_types', 'ruta' => 'catalogos/charge_types', 'icono' => 'fa-solid fa-money-bill-wave', 'parent' => 'catalogos_root', 'orden' => 4],
            ['nombre' => 'Tipos pago contrato', 'clave' => 'contract_payment_types', 'ruta' => 'catalogos/contract_payment_types', 'icono' => 'fa-solid fa-file-invoice-dollar', 'parent' => 'catalogos_root', 'orden' => 5],
            ['nombre' => 'Oficinas', 'clave' => 'offices', 'ruta' => 'catalogos/offices', 'icono' => 'fa-solid fa-building', 'parent' => 'catalogos_root', 'orden' => 6],
            ['nombre' => 'Formas de pago', 'clave' => 'payment_methods', 'ruta' => 'catalogos/payment_methods', 'icono' => 'fa-solid fa-credit-card', 'parent' => 'catalogos_root', 'orden' => 7],
            ['nombre' => 'Socios', 'clave' => 'partners', 'ruta' => 'catalogos/partners', 'icono' => 'fa-solid fa-handshake', 'parent' => 'catalogos_root', 'orden' => 8],

            ['nombre' => 'Lotificaciones', 'clave' => 'developments_module', 'ruta' => 'lotificaciones', 'icono' => 'fa-solid fa-map-location-dot', 'parent' => 'cobranza_root', 'orden' => 1],
            ['nombre' => 'Clientes', 'clave' => 'clients_module', 'ruta' => 'clientes', 'icono' => 'fa-solid fa-address-card', 'parent' => 'cobranza_root', 'orden' => 2],
            ['nombre' => 'Vendedores', 'clave' => 'sellers_module', 'ruta' => 'vendedores', 'icono' => 'fa-solid fa-user-tie', 'parent' => 'cobranza_root', 'orden' => 3],
            ['nombre' => 'Apartados', 'clave' => 'reservations_module', 'ruta' => 'apartados', 'icono' => 'fa-solid fa-bookmark', 'parent' => 'cobranza_root', 'orden' => 4],
            ...
            ['nombre' => 'Modificaciones masivas', 'clave' => 'bulk_modifications_module', 'ruta' => 'modificaciones-masivas', 'icono' => 'fa-solid fa-file-signature', 'parent' => 'cobranza_root', 'orden' => 8],
            ['nombre' => 'Autorizantes', 'clave' => 'authorizers_module', 'ruta' => 'autorizantes', 'icono' => 'fa-solid fa-user-shield', 'parent' => 'cobranza_root', 'orden' => 9],
