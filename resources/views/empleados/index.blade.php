...
<div class="page-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="fw-bold mb-1">Empleados</h3>
            <div class="text-muted">Administración de personal</div>
        </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered align-middle w-100" id="tblEmpleados">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Nombres</th>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select select2-emp" id="position_id" name="position_id"></select>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select select2-emp" id="status_id" name="status_id"></select>
                        </div>
                        <div class="col-md-12">
...
(() => {
    ...
    async function loadOptions() {
        ...
        const res = await fetch('/empleados/options');
    ...
    function resetForm() {
        form.reset();
        empleadoId.value = '';
        $('.select2-emp').val(null).trigger('change');
    }

    function initTable() {
        table = $('#tblEmpleados').DataTable({
            ajax: { url: '/empleados/datatable', dataSrc: 'data' },
            columns: [
    ...
    document.getElementById('btnNuevoEmpleado').addEventListener('click', openNew);
    form.addEventListener('submit', saveItem);

    $('#tblEmpleados').on('click', '.btn-edit', function () {
        editItem(this.dataset.id);
    });

    $('#tblEmpleados').on('click', '.btn-delete', function () {
