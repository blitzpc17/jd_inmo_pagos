        ...
        <table class="meta-table">
            <tr>
                ...
                <td style="width: 33.333%;">
                    ...
                    <div class="value">{{ $item->created_at ?? 'N/A' }}</div>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <div class="label">Concepto</div>
                    <div class="value">{{ mb_strtoupper($item->concepto ?? 'ABONO') }}</div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <tr>
            <td>
                <div class="summary-box success">
                    ...
                    <div class="big">${{ number_format($item->importe, 2) }}</div>
                </div>
            </td>
        </tr>
    </table>
        ...
        <table class="meta-table">
            <tr>
                <td style="width: 33.333%;">
                    ...
                    <div class="value">${{ number_format($voucher->importe ?? 0, 2) }}</div>
                </td>
                <td style="width: 33.333%;">
